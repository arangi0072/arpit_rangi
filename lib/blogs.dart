                                    ...
                                    builder: (context, constraints) {
                                      return Padding(
                                        ...
                                        child: SizedBox(
                                            ...
                                            child: CardItem(itemData: snapshot.data!.docs, height: height,)
                                        ),
                                      );
                                    }
                                );
...
class CardItem extends StatefulWidget {
  final List<QueryDocumentSnapshot<Object?>> itemData;
  final bool height;
          ...
          child: widget.height ? ListView.builder(
            ...
            itemBuilder: (context, rowIndex){
              ...
              return widget.itemData.length  > (index) ? Padding(
                padding: (index == widget.itemData.length - 1)? const EdgeInsets.only(top: 8.0, left: 8, right: 8, bottom: 60) : const EdgeInsets.all(8.0),
                child: Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            SizedBox(
                              height: 200,
                              width: MediaQuery.of(context).size.width,
                              child: Center(child: Image.network(widget.itemData[index]["logo"].toString(), fit: BoxFit.fitHeight,)),
                            ),
                            SizedBox(height: 8.0),
                            Text(
                              '${widget.itemData[index]["title"].toString()}',
                              style: TextStyle(fontSize: 18, color: Colors.white, fontWeight: FontWeight.bold),
                              textAlign: TextAlign.center,
                            ),
                            SizedBox(height: 8.0),
                            Text(
                              DateFormat('MMMM d, yyyy – hh:mm a').format(widget.itemData[index]["time"].toDate()),
                              style: const TextStyle(fontSize: 14, color: Colors.grey, fontWeight: FontWeight.bold),
                              textAlign: TextAlign.center,
                            ),
                            SizedBox(height: 8.0),
                            Text(
                              '${widget.itemData[index]["info"].toString().substring(0, 180).replaceAll("\\n", "")}...',
                              style: TextStyle(fontSize: 16, color: Colors.white),
                            ),
                            ...
                            InkWell(
                              onTap: () {
                                Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                      builder: (context) => MyBlogDetailPage(node: widget.itemData[index].id.toString(), data: widget.itemData[index].data() as Map<Object?, Object?>,)),
                                );
                              },
                              child: Container(
                                decoration: const BoxDecoration(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  SizedBox(
                                    height: 200,
                                    width: MediaQuery.of(context).size.width,
                                    child: Center(child: Image.network(widget.itemData[index]["logo"].toString())),
                                  ),
                                  SizedBox(height: 8.0),
                                  Text(
                                    '${widget.itemData[index]["title"].toString()}',
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  SizedBox(
                                    height: 200,
                                    width: MediaQuery.of(context).size.width,
                                    child: Center(child: Image.network(widget.itemData[index + 1]['logo'].toString())),
                                  ),
                                  SizedBox(height: 8.0),
                                  Text(
                                    '${widget.itemData[index + 1]['title'] ?? 'No title'}',
                                    style: TextStyle(fontSize: 18, color: Colors.white, fontWeight: FontWeight.bold),
                                    textAlign: TextAlign.center,
                                  ),
                                  SizedBox(height: 8.0),
                                  Text(
                                    DateFormat('MMMM d, yyyy – hh:mm a').format(widget.itemData[index+1]["time"].toDate()),
                                    style: const TextStyle(fontSize: 14, color: Colors.grey, fontWeight: FontWeight.bold),
                                    textAlign: TextAlign.center,
                                  ),
                                  SizedBox(height: 8.0),
                                  Text(
                                    '${widget.itemData[index + 1]["info"].toString().substring(0, 180).replaceAll("\\n", "")}...',
                                    style: TextStyle(fontSize: 16, color: Colors.white),
                                  ),
                                  SizedBox(height: 15.0),
                                  InkWell(
                                    onTap: () {
                                      Navigator.push(
                                        context,
                                        MaterialPageRoute(
                                            builder: (context) => MyBlogDetailPage(node: widget.itemData[index + 1].id.toString(), data: widget.itemData[index + 1].data() as Map<Object?, Object?>,)),
                                      );
                                    },
                                    child: Container(
                                      decoration: const BoxDecoration(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  SizedBox(
                                    height: 200,
                                    width: MediaQuery.of(context).size.width,
                                    child: Center(child: Image.network(widget.itemData[index + 2]['logo'].toString())),
                                  ),
                                  SizedBox(height: 8.0),
                                  Text(
                                    '${widget.itemData[index+2]['title'] ?? 'No title'}',
                                    style: TextStyle(fontSize: 18, color: Colors.white, fontWeight: FontWeight.bold),
                                    textAlign: TextAlign.center,
                                  ),
                                  SizedBox(height: 8.0),
                                  Text(
                                    DateFormat('MMMM d, yyyy – hh:mm a').format(widget.itemData[index+2]["time"].toDate()),
                                    style: const TextStyle(fontSize: 14, color: Colors.grey, fontWeight: FontWeight.bold),
                                    textAlign: TextAlign.center,
                                  ),
                                  SizedBox(height: 8.0),
                                  Text(
                                    '${widget.itemData[index+2]["info"].toString().substring(0, 180).replaceAll("\\n", "")}...',
                                    style: TextStyle(fontSize: 16, color: Colors.white),
                                  ),
                                  SizedBox(height: 15.0),
                                  InkWell(
                                    onTap: () {
                                      Navigator.push(
                                        context,
                                        MaterialPageRoute(
                                            builder: (context) => MyBlogDetailPage(node: widget.itemData[index + 2].id.toString(), data: widget.itemData[index+2].data() as Map<Object?, Object?>,)),
                                      );
                                    },
                                    child: Container(
                                      decoration: const BoxDecoration(
